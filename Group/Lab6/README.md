...
For the fast exponentiation, we are interested in the elapsed time of the function. For a set of calls for both functions with absurd arguments, we obtain:
...
* `*Lecture6> expM 8 252525252525 9` results in `GNU MP: Cannot allocate memory (size=805474320)`.   
